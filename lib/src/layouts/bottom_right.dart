...
/// A layout that places the app at the bottom right of the screenshot.
class ScreenshotLayoutBottomRight extends StatelessWidget {
  /// Creates a new [ScreenshotLayoutBottomRight].
  const ScreenshotLayoutBottomRight({
    required this.app,
          ...
          Expanded(
            child: OverflowBox(
              ...
              child: Transform.translate(
                offset: Offset(device.screenSize.width / 2, 0),
                child: DeviceFrame(
                  device: device,
                  screen: app,
                ),
