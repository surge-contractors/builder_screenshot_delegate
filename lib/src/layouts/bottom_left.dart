...
/// A layout that places the app at the bottom left of the screenshot.
class ScreenshotLayoutBottomLeft extends StatelessWidget {
  /// Creates a new [ScreenshotLayoutBottomLeft].
  const ScreenshotLayoutBottomLeft({
