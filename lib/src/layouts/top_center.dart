...
/// A layout that places the app at the top center of the screenshot.
class ScreenshotLayoutTopCenter extends StatelessWidget {
  /// Creates a new [ScreenshotLayoutTopCenter].
  const ScreenshotLayoutTopCenter({
    required this.app,
