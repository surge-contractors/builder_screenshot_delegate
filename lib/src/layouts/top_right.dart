...
//// A layout that places the app at the top right of the screenshot.
class ScreenshotLayoutTopRight extends StatelessWidget {
  /// Creates a new [ScreenshotLayoutTopRight].
  const ScreenshotLayoutTopRight({
    required this.app,
