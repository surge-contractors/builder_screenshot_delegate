...
/// A layout that places the app at the center left of the screenshot.
class ScreenshotLayoutCenterLeft extends StatelessWidget {
  /// Creates a new [ScreenshotLayoutCenterLeft].
  const ScreenshotLayoutCenterLeft({
